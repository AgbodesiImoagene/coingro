...
class Exchange:
    ...
    def __init__(self, config: Dict[str, Any], validate: bool = True) -> None:
        ...
        if exchange_config.get('_cg_has_params'):
            self._cg_has = deep_merge_dicts(exchange_config.get('_cg_has_params'),
                                            self._cg_has)
    ...
    def _ccxt_config(self) -> Dict:
        ...
        if self.trading_mode == TradingMode.MARGIN:
            ...
            return {
                "options": {
                    "defaultType": self._cg_has["ccxt_futures_name"]
                }
            }
        else:
            return {}
    ...
    def ohlcv_candle_limit(
        ...
        """
        return int(self._cg_has.get('ohlcv_candle_limit_per_timeframe', {}).get(
    ...
    def market_is_future(self, market: Dict[str, Any]) -> bool:
        return (
            market.get(self._cg_has["ccxt_futures_name"], False) is True and
    ...
    def validate_ordertypes(self, order_types: Dict) -> None:
        ...
        if (order_types.get("stoploss_on_exchange")
                and not self._cg_has.get("stoploss_on_exchange", False)):
            raise OperationalException(
    ...
    def validate_pricing(self, pricing: Dict) -> None:
        ...
        if (not pricing.get('use_order_book', False) and (
                ...
                or not self._cg_has['tickers_have_price'])):
    ...
    def validate_order_time_in_force(self, order_time_in_force: Dict) -> None:
        ...
        """
        if any(v not in self._cg_has["order_time_in_force"]
    ...
    def fetch_l2_order_book(self, pair: str, limit: int = 100) -> dict:
        ...
        """
        limit1 = self.get_next_limit_in_list(limit, self._cg_has['l2_limit_range'],
                                             self._cg_has['l2_limit_range_required'])
        try:
    ...
    def _build_coroutine(self, pair: str, timeframe: str, candle_type: CandleType,
        ...
        if (not since_ms
                and (self._cg_has["ohlcv_require_since"] or self.required_candle_call_count > 1)):
    ...
    def _fetch_and_calculate_funding_fees(
        ...
        timeframe_ff = self._cg_has.get('funding_fee_timeframe',
                                        self._cg_has['mark_ohlcv_timeframe'])
        ...
        mark_comb: PairWithTimeframe = (
            pair, timeframe, CandleType.from_string(self._cg_has["mark_ohlcv_price"]))
    ...
    def dry_run_liquidation_price(
        ...
        if self.trading_mode == TradingMode.FUTURES and self.margin_mode == MarginMode.ISOLATED:
            ...
            if market['inverse']:
                raise OperationalException(
                    "Coingro does not yet support inverse contracts")
