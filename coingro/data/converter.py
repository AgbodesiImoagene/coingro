...
from coingro.constants import DEFAULT_DATAFRAME_COLUMNS, DEFAULT_TRADES_COLUMNS, TradeList
...
def convert_ohlcv_format(
    config: Dict[str, Any], convert_from: str, convert_to: str, erase: bool, candle_type: CandleType
):
    """
    ...
    if "pairs" not in config:
        ...
        for timeframe in timeframes:
            config["pairs"].extend(
                src.ohlcv_get_pairs(config["datadir"], timeframe, candle_type=candle_type)
            )
