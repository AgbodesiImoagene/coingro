...
from coingro.rpc.api_server.api_schemas import AccessAndRefreshToken, AccessToken
from coingro.rpc.api_server.deps import get_api_config
...
def token_login(
    form_data: HTTPBasicCredentials = Depends(HTTPBasic()), api_config=Depends(get_api_config)
):
