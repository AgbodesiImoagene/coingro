...
def get_strategy_run_id(strategy) -> str:
    ...
    # Include _cg_params_from_file - so changing parameter files cause cache eviction
    digest.update(rapidjson.dumps(
        strategy._cg_params_from_file, default=str, number_mode=rapidjson.NM_NAN).encode('utf-8'))
