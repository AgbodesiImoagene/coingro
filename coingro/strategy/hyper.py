    ...
    def cg_load_hyper_params(self, hyperopt: bool = False) -> None:
        ...
        * Parameter defaults
        ...
        buy_params = deep_merge_dicts(
            self._cg_params_from_file.get("buy", {}), getattr(self, "buy_params", {})
        )
        sell_params = deep_merge_dicts(
            self._cg_params_from_file.get("sell", {}), getattr(self, "sell_params", {})
        )
        protection_params = deep_merge_dicts(
            self._cg_params_from_file.get("protection", {}), getattr(self, "protection_params", {})
        )
