...
from coingro.misc import deep_merge_dicts, json_load
from coingro.optimize.hyperopt_tools import HyperoptTools
from coingro.strategy.parameters import BaseParameter
...
class HyperStrategyMixin:
    ...
    def __init__(self, config: Dict[str, Any], *args, **kwargs):
        ...
        """
        self.config = config
        self.cg_buy_params: List[BaseParameter] = []
        self.cg_sell_params: List[BaseParameter] = []
        self.cg_protection_params: List[BaseParameter] = []

        params = self.load_params_from_file()
        params = params.get('params', {})
        self._cg_params_from_file = params
        # Init/loading of parameters is done as part of cg_bot_start().
    ...
    def enumerate_parameters(self, category: str = None) -> Iterator[Tuple[str, BaseParameter]]:
        ...
        if category is None:
            params = self.cg_buy_params + self.cg_sell_params + self.cg_protection_params
        else:
            params = getattr(self, f"cg_{category}_params")
    ...
    def cg_load_params_from_file(self) -> None:
        """
        Load Parameters from parameter file
        Should/must run before config values are loaded in strategy_resolver.
        """
        if self._cg_params_from_file:
            # Set parameters from Hyperopt results file
            params = self._cg_params_from_file
    ...
    def cg_load_hyper_params(self, hyperopt: bool = False) -> None:
        """
        ...
        * Parameter defaults
        ...
        buy_params = deep_merge_dicts(self._cg_params_from_file.get('buy', {}),
                                      getattr(self, 'buy_params', {}))
        sell_params = deep_merge_dicts(self._cg_params_from_file.get('sell', {}),
                                       getattr(self, 'sell_params', {}))
        protection_params = deep_merge_dicts(self._cg_params_from_file.get('protection', {}),
                                             getattr(self, 'protection_params', {}))

        self._cg_load_params(buy_params, 'buy', hyperopt)
        self._cg_load_params(sell_params, 'sell', hyperopt)
        self._cg_load_params(protection_params, 'protection', hyperopt)
    ...
    def _cg_load_params(self, params: Dict, space: str, hyperopt: bool = False) -> None:
        """
        ...
        param_container: List[BaseParameter] = getattr(self, f"cg_{space}_params")
