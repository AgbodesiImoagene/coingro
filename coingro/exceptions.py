class CoingroException(Exception):
    """
    Coingro base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(CoingroException):
    """
...
class DependencyException(CoingroException):
    """
...
class StrategyError(CoingroException):
    """
