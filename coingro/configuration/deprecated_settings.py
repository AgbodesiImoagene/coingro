...
def check_conflicting_settings(
    ...
    if name_new in section_new_config and name_old in section_old_config:
        ...
        raise OperationalException(
            ...
            "This deprecated setting will be removed in the next versions of Coingro. "
...
def process_removed_setting(
    config: Dict[str, Any], section1: str, name1: str, section2: Optional[str], name2: str
) -> None:
    """
...
def process_deprecated_setting(
    ...
    if name_old in section_old_config:
        ...
        logger.warning(
            ...
            "will be removed in the next versions of Coingro. "
