...
from coingro.commands.data_commands import (start_convert_data, start_convert_trades,
                                            start_download_data, start_list_data)
from coingro.commands.db_commands import start_convert_db
from coingro.commands.deploy_commands import (start_create_userdir, start_install_ui,
                                              start_new_strategy)
from coingro.commands.hyperopt_commands import start_hyperopt_list, start_hyperopt_show
from coingro.commands.list_commands import (start_list_exchanges, start_list_markets,
                                            start_list_strategies, start_list_timeframes,
                                            start_show_trades)
from coingro.commands.optimize_commands import (start_backtesting, start_backtesting_show,
