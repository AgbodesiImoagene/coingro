...
from coingro.misc import round_coin_value
...
def start_backtesting(args: Dict[str, Any]) -> None:
    ...
    logger.info('Starting coingro in Backtesting mode')
...
def start_backtesting_show(args: Dict[str, Any]) -> None:
    ...
    from coingro.data.btanalysis import load_backtest_stats
    from coingro.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: Dict[str, Any]) -> None:
    ...
    logger.info('Starting coingro in Hyperopt mode')
    ...
    try:
        ...
        logger.info("Another running instance of coingro Hyperopt detected.")
        logger.info("Simultaneous execution of multiple Hyperopt commands is not supported. "
                    "Hyperopt module is resource hungry. Please run your Hyperopt sequentially "
                    "or on separate machines.")
        logger.info("Quitting now.")
        # TODO: return False here in order to help coingro to exit
...
def start_edge(args: Dict[str, Any]) -> None:
    ...
    logger.info('Starting coingro in Edge mode')
