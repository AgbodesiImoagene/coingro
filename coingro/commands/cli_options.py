...
from coingro.constants import HYPEROPT_LOSS_BUILTIN
...
AVAILABLE_CLI_OPTIONS = {
    ...
    "enter_reason_list": Arg(
        "--enter-reason-list",
        help=(
            "Comma separated list of entry signals to analyse. Default: all. "
    ...
    "exit_reason_list": Arg(
        "--exit-reason-list",
        help=(
            "Comma separated list of exit signals to analyse. Default: all. "
    ...
    "indicator_list": Arg(
        "--indicator-list",
        help=(
            "Comma separated list of indicators to analyse. "
