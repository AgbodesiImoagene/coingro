...
PROTECTED_CREDENTIALS = {
    "exchange": {"key": None, "secret": None, "password": None, "uid": None},
    "db_config": {"username": None, "password": None},
    "db_url": None,
    "original_config": {
        "exchange": {"key": None, "secret": None, "password": None, "uid": None},
        "db_config": {"username": None, "password": None},
...
SUPPORTED_STAKE_CURRENCIES = ["BTC", "ETH", "USDT", "USDC", "BUSD", "EUR"]

SUPPORTED_FORCEENTER_CURRENCIES = ["BTC, ETH", "XRP", "ADA", "SOL"]
