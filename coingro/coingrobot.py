...
from coingro import __id__, __version__, constants
...
from coingro.enums import (ExitCheckTuple, ExitType, RPCMessageType, RunMode, SignalDirection,
                             State, TradingMode)
...
class CoingroBot(LoggingMixin):
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        file_dump_json(constants.DEFAULT_CONFIG_SAVE, tempconf, pretty_print=True, nan=True);
    ...
    def startup_update_open_orders(self):
        ...
        for order in orders:
            try:
                fo = self.exchange.fetch_order_or_stoploss_order(order.order_id, order.cg_pair,
                                                                 order.cg_order_side == 'stoploss')
...
#
    ...
    def manage_open_orders(self) -> None:
        ...
        for trade in Trade.get_open_order_trades():
            ...
            if not_closed:
                if fully_cancelled or (order_obj and self.strategy.cg_check_timed_out(
...
#
    ...
    def get_real_amount(self, trade: Trade, order: Dict, order_obj: Order) -> float:
        ...
        if self.exchange.order_has_fee(order):
            ...
            logger.info(f"Fee for Trade {trade} [{order_obj.cg_order_side}]: "
