...
def test_validate_stake_amount(
    ...
    mocker.patch("coingro.wallets.Wallets.get_available_stake_amount",
...
def test_get_starting_balance(mocker, default_conf, available_capital, closed_profit,
    ...
    mocker.patch("coingro.persistence.models.Trade.get_total_closed_profit",
                 return_value=closed_profit)
    mocker.patch("coingro.persistence.models.Trade.total_open_trades_stakes",
