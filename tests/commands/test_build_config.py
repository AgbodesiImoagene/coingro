...
from coingro.commands.build_config_commands import (ask_user_config, ask_user_overwrite,
...
def test_start_new_config(mocker, caplog, exchange):
    ...
    mocker.patch('coingro.commands.build_config_commands.ask_user_config',
...
def test_ask_user_overwrite(mocker):
    ...
    """
    prompt_mock = mocker.patch('coingro.commands.build_config_commands.prompt',
