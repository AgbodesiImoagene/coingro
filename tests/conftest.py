...
def patched_configuration_load_config_file(mocker, config) -> None:
    mocker.patch(
        'coingro.configuration.load_config.load_config_file',
...
def patch_wallet(mocker, free=999.9) -> None:
    mocker.patch('coingro.wallets.Wallets.get_free', MagicMock(
        return_value=free
    ))


def patch_whitelist(mocker, conf) -> None:
    mocker.patch('coingro.coingrobot.CoingroBot._refresh_active_whitelist',
