...
class StrategyTestV3(IStrategy):
    """
    Strategy used by tests coingro bot.
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (qtpylib.crossed_below(dataframe["rsi"], self.sell_rsi.value)), "enter_short"
        ] = 1
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (qtpylib.crossed_above(dataframe["rsi"], self.buy_rsi.value)), "exit_short"
        ] = 1
