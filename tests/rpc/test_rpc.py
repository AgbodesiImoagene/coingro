...
def test_rpc_trade_status(default_conf, ticker, fee, mocker) -> None:
    ...
    assert results[0] == {
        ...
        'orders': [{
            ...
            'cost': 0.0009999999999054, 'filled': 91.07468123, 'cg_order_side': 'buy',
            'order_date': ANY, 'order_timestamp': ANY, 'order_filled_date': ANY,
            'order_filled_timestamp': ANY, 'order_type': 'limit', 'price': 1.098e-05,
            'is_open': False, 'pair': 'ETH/BTC', 'order_id': ANY,
            'remaining': ANY, 'status': ANY, 'cg_is_entry': True,
        }],
    }
...
def test_rpc_delete_trade(mocker, default_conf, fee, markets, caplog, is_short):
    ...
    stoploss_mock = mocker.patch('coingro.exchange.Exchange.cancel_stoploss_order',
    ...
    cancel_mock = mocker.patch('coingro.exchange.Exchange.cancel_order',
                               side_effect=InvalidOrderException)
