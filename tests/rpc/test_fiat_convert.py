...
def test_fiat_convert_find_price(mocker):
    ...
    mocker.patch('coingro.rpc.fiat_convert.CryptoToFiatConverter._load_cryptomap',
                 return_value=None)
...
def test_fiat_convert_get_price(mocker):
    find_price = mocker.patch('coingro.rpc.fiat_convert.CryptoToFiatConverter._find_price',
