...
from coingro.enums.candletype import CandleType
from coingro.exchange.exchange import timeframe_to_minutes
...
def test_load_leverage_tiers_okx(default_conf, mocker, markets):
    ...
    api_mock.fetch_market_leverage_tiers = get_mock_coro(
        side_effect=[
            [
                {
                    "tier": 1,
    ...
    assert exchange._leverage_tiers == {
        "ADA/USDT:USDT": [
            {"min": 0, "max": 500, "mmr": 0.02, "lev": 75, "maintAmt": None},
            {"min": 501, "max": 1000, "mmr": 0.025, "lev": 50, "maintAmt": None},
            {"min": 1001, "max": 2000, "mmr": 0.03, "lev": 20, "maintAmt": None},
        ],
        "ETH/USDT:USDT": [
            {"min": 0, "max": 2000, "mmr": 0.01, "lev": 75, "maintAmt": None},
            {"min": 2001, "max": 4000, "mmr": 0.015, "lev": 50, "maintAmt": None},
            {"min": 4001, "max": 8000, "mmr": 0.02, "lev": 20, "maintAmt": None},
        ],
    }
