...
from coingro.persistence.trade_model import LocalTrade
...
def test_backtest_results(default_conf, fee, mocker, caplog, data: BTContainer) -> None:
    ...
    mocker.patch("coingro.exchange.Exchange.get_fee", return_value=0.0)
    ...
    mocker.patch("coingro.exchange.Binance.get_max_leverage", return_value=100)
