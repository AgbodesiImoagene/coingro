...
def test_store_backtest_stats(testdatadir, mocker):
    ...
    dump_mock = mocker.patch("coingro.optimize.optimize_reports.file_dump_json")
...
def test_store_backtest_candles(testdatadir, mocker):
    ...
    dump_mock = mocker.patch("coingro.optimize.optimize_reports.file_dump_joblib")
...
def test_text_table_exit_reason():
    ...
    assert (
        text_table_exit_reason(exit_reason_stats=exit_reason_stats, stake_currency="BTC")
        == result_str
    )
