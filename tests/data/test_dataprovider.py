...
def test_historic_ohlcv(mocker, default_conf, ohlcv_history):
    ...
    mocker.patch("coingro.data.dataprovider.load_pair_history", historymock)
...
def test_historic_ohlcv_dataformat(mocker, default_conf, ohlcv_history):
    ...
    mocker.patch("coingro.data.history.hdf5datahandler.HDF5DataHandler._ohlcv_load", hdf5loadmock)
    mocker.patch("coingro.data.history.jsondatahandler.JsonDataHandler._ohlcv_load", jsonloadmock)
...
def test_refresh(mocker, default_conf, ohlcv_history):
    ...
    mocker.patch("coingro.exchange.Exchange.refresh_latest_ohlcv", refresh_mock)
