...
def test_generate_candlestick_graph_no_signals_no_trades(default_conf, mocker, testdatadir, caplog):
    row_mock = mocker.patch('coingro.plot.plotting.add_indicators',
                            MagicMock(side_effect=fig_generating_mock))
    trades_mock = mocker.patch('coingro.plot.plotting.plot_trades',
                               MagicMock(side_effect=fig_generating_mock))
...
def test_generate_plot_file(mocker, caplog):
    ...
    store_plot_file(fig, filename="coingro-plot-UNITTEST_BTC-5m.html",
